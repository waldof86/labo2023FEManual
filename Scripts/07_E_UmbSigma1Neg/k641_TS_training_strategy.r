# Experimentos Revision1 con future07
...
PARAM  <- list()
PARAM$experimento <- "07_E_TS_UmbSigma1Neg"

PARAM$exp_input  <- "07_E_FE_UmbSigma1Neg"
...
PARAM$train$semilla  <- 201107  # cambiar por su propia semilla  !!! 
