# Experimentos Colaborativos Futuro 07 Exp2
...
PARAM  <- list()
PARAM$experimento <- "07_E_TS_ExVarComb"

PARAM$exp_input  <- "07_E_FE_ExVarComb"
...
PARAM$train$semilla  <- 604997  # cambiar por su propia semilla  !!! 
