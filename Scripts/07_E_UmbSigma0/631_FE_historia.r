...
PARAM  <- list()
PARAM$experimento <- "07_E_FE_UmbSigma0"

PARAM$exp_input  <- "07_E_DR_UmbSigma0"
...
CanaritosAsesinos  <- function( canaritos_ratio=0.2 )
{
  ...
  umbral  <- tb_importancia[ Feature %like% "canarito", median(pos) + 0*sd(pos) ]  #Atencion corto en la mediana mas DOS desvios!!
