...
PARAM  <- list()
PARAM$experimento <- "07_E_FE_UmbSigma125"

PARAM$exp_input  <- "07_E_DR_UmbSigma125"
...
CanaritosAsesinos  <- function( canaritos_ratio=0.2 )
{
  ...
  umbral  <- tb_importancia[ Feature %like% "canarito", median(pos) + 1.25*sd(pos) ]  #Atencion corto en la mediana mas DOS desvios!!
